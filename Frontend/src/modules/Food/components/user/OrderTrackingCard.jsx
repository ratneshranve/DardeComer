...
const CookingAnimation = memo(() => (
  <div className="relative w-12 h-12 flex items-center justify-center rounded-xl bg-blue-50 border border-blue-100 overflow-visible shadow-[0_4px_15px_rgba(0,26,148,0.15)] shrink-0">
    ...
    <motion.div animate={{ rotate: [-2, 2, -2] }} transition={{ duration: 0.6, repeat: Infinity, ease: "easeInOut" }} className="relative z-10 mt-1">
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#001A94] drop-shadow-sm">
        {/* Cooker Body */}
    ...
    <motion.div animate={{ opacity: [0.4, 0.8, 0.4], scaleX: [0.8, 1.2, 0.8] }} transition={{ duration: 0.6, repeat: Infinity, ease: "easeInOut" }} className="absolute bottom-0 w-full flex justify-center z-0">
      <div className="w-4 h-1 bg-[#001A94] blur-[2px] rounded-full" />
    </motion.div>
  </div>
));
    ...
    <AnimatePresence>
      ...
      >
        <div 
          ...
          className="relative bg-white/95 backdrop-blur-xl rounded-[20px] p-4 shadow-[0_8px_30px_rgba(0,26,148,0.15)] border border-blue-100/60 overflow-visible cursor-pointer group"
        >
          {/* Subtle gradient background mesh */}
          <div className="absolute inset-0 bg-gradient-to-r from-blue-50/50 via-white/40 to-white/80 opacity-60 pointer-events-none rounded-[20px]" />
          ...
          <div className="flex items-center gap-4 relative z-10 w-full">
            ...
            <div className="flex-1 min-w-0 pr-4">
              ...
              <div className="flex items-center gap-1.5 mt-0.5">
                ...
                <ChevronRight className="w-3.5 h-3.5 text-[#001A94] shrink-0 group-hover:translate-x-1 transition-transform" />
              </div>
            </div>

            <div className="bg-gradient-to-br from-[#001A94] to-[#0033CC] shadow-lg shadow-blue-500/20 rounded-xl px-4 py-2 shrink-0 flex flex-col items-center justify-center border border-blue-200">
              <p className="text-blue-50 [10px] font-bold uppercase tracking-wider opacity-95 leading-tight mb-[2px]">
                arriving in
              </p>
