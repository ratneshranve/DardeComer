    ...
    >
      ...
      <div className="px-4 py-6">
        ...
        <motion.button
          ...
          className="w-full flex items-center justify-between gap-3 rounded-2xl border border-red-200 bg-white px-4 py-4 text-left mt-4"
        >
          <div className="flex items-center gap-3 min-w-0">
          ...
          <>
            ...
            >
              <div className="text-center">
                ...
                <p className="mt-1 text-sm text-gray-500">This action is permanent and cannot be undone.</p>
              </div>
