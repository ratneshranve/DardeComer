          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-600 mt-1">
                Should always be available for Dar De Comer to reach out for live order support and order reminders.
              </p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg p-4 mb-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-600 mt-1">
                Number for Dar De Comer customers to call your restaurant.
              </p>
            </div>
          </div>
