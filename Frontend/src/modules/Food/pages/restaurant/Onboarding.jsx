          ...
          <div>
            ...
            <div className="mt-2 flex flex-wrap items-center gap-2">
              <button
                ...
                className={`px-3 py-1.5 text-xs rounded-full border ${normalizeBusinessModelLabel(step1.businessModel) === BUSINESS_MODEL_RESTAURANT
              ...
              <button
                ...
                className={`px-3 py-1.5 text-xs rounded-full border ${normalizeBusinessModelLabel(step1.businessModel) === BUSINESS_MODEL_HOME_KITCHEN
                    ? "bg-primary text-white border-gray-900"
                    : "bg-white text-gray-700 border-gray-200"
                  } ${!isEditing ? "opacity-70 cursor-not-allowed" : ""}`}
              >
