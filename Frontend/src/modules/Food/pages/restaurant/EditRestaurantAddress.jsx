...
export default function EditRestaurantAddress() {
  ...
  const formatAddress = (loc) => {
    ...
    // Priority 1: Use formattedAddress if it exists
    ...
    <div className="h-screen bg-white overflow-hidden flex flex-col">
      ...
      <div className="relative flex-1 min-h-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none z-10">
          {/* Tooltip */}
          <div className="bg-primary text-white px-3 py-2 rounded-lg mb-2 whitespace-nowrap shadow-lg">
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-white rounded-t-3xl z-20 px-4 pt-6">
          ...
          <div className="bg-blue-100 rounded-lg px-4 py-3 mb-4">
            <p className="text-sm text-gray-900">
              Customers and Dar De Comer delivery partners will use this to locate your outlet.
            </p>
          </div>
          ...
          <div className="pb-4">
            <button
              ...
              className="w-full bg-primary text-white font-semibold py-4 text-base rounded-lg"
            >
              Update
            </button>
          </div>
      ...
      >
        <div className=" space-y-0">
          ...
          <button
            ...
            className="w-full bg-primary text-white font-semibold py-4 rounded-lg mt-6"
          >
            Proceed to update
          </button>
        </div>
