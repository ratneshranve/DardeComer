...
export default function Restaurants() {
  ...
  return (
    <AnimatedPage className="min-h-screen bg-gradient-to-b from-blue-50/30 dark:from-[#0a0a0a] via-white dark:via-[#0a0a0a] to-blue-100/20 dark:to-[#0a0a0a]">
                        ...
                        <CardContent className="flex-1 flex flex-col justify-between p-3 sm:p-4 md:p-5 lg:p-6 min-w-0 overflow-hidden">
                          <div className="flex-1 flex flex-col justify-between gap-2">
                            ...
                            <div className="flex items-center justify-between gap-2 mt-auto pt-2 border-t border-gray-200 dark:border-gray-800 flex-shrink-0">
                              ...
                              <Button className="bg-[#001A94] hover:opacity-90 dark:hover:opacity-80 text-white text-xs sm:text-sm h-7 sm:h-8 px-3 sm:px-4 flex-shrink-0 transition-opacity">
                                Order Now
                              </Button>
                            </div>
                          </div>
