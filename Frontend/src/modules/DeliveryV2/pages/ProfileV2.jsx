...
export const ProfileV2 = () => {
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      try {
        await deliveryAPI.deleteAccount(null, fcmToken, platform)
      } catch (apiError) {
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl p-4 flex items-center justify-between gap-4">
            ...
            <button
              ...
              className="shrink-0 bg-primary text-white px-4 py-2 rounded-lg text-xs font-bold uppercase tracking-widest shadow-md"
            >
              Share
            </button>
          </div>
      ...
      {showDeleteConfirm && (
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-gray-500 mb-5">Are you sure you want to delete your account? This action is permanent and cannot be undone.</p>
            <div className="flex items-center gap-3">
              <button
                onClick={() => setShowDeleteConfirm(false)}
                className="flex-1 h-11 rounded-xl border border-gray-200 text-gray-700 font-bold"
